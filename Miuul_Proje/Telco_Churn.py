...
# hayali bir telekom şirketi hakkında bilgi içerir.
...
# Müşteri hesap bilgileri – ne kadar süredir müşteri oldukları, sözleşme, ödeme yöntemi, kağıtsız faturalandırma, aylık ücretler
# ve toplam ücretler
...
df = pd.read_csv(r"C:\Users\NUR\Desktop\DTS02\VBO_17\Telco-Customer-Churn.csv")
df.head()
df.shape
df.info()
...
df_2 = df[df["tenure"] == 0]
df_2[["TotalCharges", "MonthlyCharges", "tenure"]]
##################################
# GÖREV 1: KEŞİFCİ VERİ ANALİZİ
##################################
